  ...
  return (
    <header>
      ...
      <section className="flex justify-between items-center py-3">
        ...
        <Link
          href="/signup"
          className="py-2 w-fit px-6 hover:cursor-pointer text-sm font-semibold border-midnightBlue-800 border rounded-full text-midnightBlue-800 hover:text-doveGray-0 hover:bg-midnightBlue-950">
          Sign Up
        </Link>
      </section>
    </header>
