...
export default function ImageAuth() {
  return (
    <div className="w-full h-full md:block hidden">
      <section className="bg-primary-500 items-center justify-center flex opacity-95 w-full h-full">
        <div className="flex flex-col items-center gap-1">
          ...
          <span
            className={`${signatureFont.className} text-primary-50 text-lg`}>
            Journey Of Youth
          </span>
          <span className="text-sm text-primary-50">
            Let Acenda accompany you on your trips.
          </span>
        </div>
      </section>
    </div>
